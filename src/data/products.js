...
export const products = [
  {
    ...
    image: createPlaceholderImage('晨曦粉霧蝴蝶蘭', CATEGORY_META.orchid.tone),
    originalPrice: 5680,
    memberPrice: 5180,
  ...
  },
  {
    ...
    name: '月映白金蝴蝶蘭',
    category: CATEGORY_META.orchid.key,
    image: createPlaceholderImage('月映白金蝴蝶蘭', CATEGORY_META.orchid.tone),
    originalPrice: 6880,
    memberPrice: 6280,
  ...
  },
  {
    ...
    name: '紫霧晨露蝴蝶蘭',
    category: CATEGORY_META.orchid.key,
    image: createPlaceholderImage('紫霧晨露蝴蝶蘭', CATEGORY_META.sympathy.tone),
    originalPrice: 7280,
    memberPrice: 6680,
  ...
  },
  {
    ...
    image: createPlaceholderImage('盛放祝賀花籃', CATEGORY_META.basket.tone),
    originalPrice: 4280,
    memberPrice: 3890,
  ...
  },
  {
    ...
    name: '暖陽典雅花籃',
    category: CATEGORY_META.basket.key,
    image: createPlaceholderImage('暖陽典雅花籃', CATEGORY_META.basket.tone),
    originalPrice: 4980,
    memberPrice: 4520,
  ...
  },
  {
    ...
    name: '綠意開幕祝福花籃',
    category: CATEGORY_META.basket.key,
    image: createPlaceholderImage('綠意開幕祝福花籃', CATEGORY_META.potted.tone),
    originalPrice: 4580,
    memberPrice: 4120,
  ...
  },
  {
    ...
    image: createPlaceholderImage('霧粉玫瑰盆花', CATEGORY_META.orchid.tone),
    originalPrice: 2480,
    memberPrice: 2280,
  ...
  },
  {
    ...
    name: '靜謐綠意盆花',
    category: CATEGORY_META.potted.key,
    image: createPlaceholderImage('靜謐綠意盆花', CATEGORY_META.potted.tone),
    originalPrice: 2180,
    memberPrice: 1990,
  ...
  },
  {
    ...
    name: '奶霜花園盆景',
    category: CATEGORY_META.potted.key,
    image: createPlaceholderImage('奶霜花園盆景', CATEGORY_META.potted.tone),
    originalPrice: 2880,
    memberPrice: 2590,
  ...
  },
  {
    ...
    image: createPlaceholderImage('靜心追思花禮', CATEGORY_META.sympathy.tone),
    originalPrice: 3680,
    memberPrice: 3380,
  ...
  },
  {
    ...
    name: '安然白緞追思盆花',
    category: CATEGORY_META.sympathy.key,
    image: createPlaceholderImage('安然白緞追思盆花', CATEGORY_META.sympathy.tone),
    originalPrice: 3280,
    memberPrice: 2990,
  ...
  },
  {
    ...
    name: '香檳金雙梗蝴蝶蘭',
    category: CATEGORY_META.orchid.key,
    image: createPlaceholderImage('香檳金雙梗蝴蝶蘭', CATEGORY_META.basket.tone),
    originalPrice: 5980,
    memberPrice: 5480,
